...
<body>
	<div class="container">
		...
		<hr><hr>
			...
			<h2 align="center"><strong> Product Details</strong></h2>
		</div>
				...
				<form:form action="${pageContext.request.contextPath}/addProducts"
					...
					<div class="form-group">
						<label for="price">Product Price</label> <form:input
							path="price" id="price" class="form-control" />
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<form:textarea path="quantity" id="qty" class="form-control" />
					</div>
					
						<div class="form-group">
							<label for="images">Upload File</label> <form:input type="file"
								class="form-control-file" id="images" path="images" />
						</div>
